...
$sql = "SELECT comments.id, comments.comment, comments.status, posts.title FROM comments 
INNER JOIN posts ON comments.pid=posts.id WHERE comments.id=?";
$result = $db->prepare($sql);
...
<div id="page-wrapper" style="min-height: 345px;">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Welcome to Edit Comment Page</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Edit and Update Comment Status 
                </div>
                        ...
                        <div class="col-lg-12">
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Change Comment Status</label>
                                            <div class="radio">
                                                <label>
