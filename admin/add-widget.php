                        ...
                        <div class="col-lg-12">
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="title" placeholder="Enter Widget Title" value="<?php if(isset($_POST['title'])){ echo $_POST['title'];} ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="type" id="optionsRadios4" value="articles">Top Post
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="type" id="optionsRadios5" value="pages">Pages
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
