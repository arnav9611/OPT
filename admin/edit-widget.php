                ...
                <div class="row">
                        <div class="col-lg-12">
                            <form role="form" method="post">
                                ...
                                <!----Important Field should pass id otherwise no change------------------->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="type" id="optionsRadios4" value="articles" <?php if($widget['type'] == 'articles'){ echo "checked"; } ?>>Recent Articles
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="type" id="optionsRadios5" value="pages" <?php if($widget['type'] == 'pages'){ echo "checked"; } ?>>Pages
                                        </label>
                                    </div>
                                </div>
