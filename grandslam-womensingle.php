...
$sql = "SELECT * FROM grandslam WHERE header='wtasingle' ORDER BY year DESC";
...
<div class="row">
  ...
  <h1 class="page-header" style="background:white;color:black;margin:2px;font-family:Anton;text-decoration:underline;font-size:1.9rem"> Women's Single  </h1>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover" >
                                    ...
                                    <?php
                                        ...
                                        <tr >
                                            <td style="font-size:0.8rem"><?php echo $grand['name']; ?></td>
